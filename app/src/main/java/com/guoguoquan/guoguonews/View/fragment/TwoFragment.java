...
public class TwoFragment extends BaseFragment implements IViewGetNetData {
    @Override
    public void initView() {
        super.initView();
        GetNetDataPresenter.getInstance(this,2).go(2, new String[]{"size", "page"}, new String[]{"100", "1"});
    ...
    public void showSuccess(SparseArray<NewsBean> mDatas) {
        ...
        mRecyclerViewAdapter = new MyRecyclerViewAdapter(mContext, mDatas);
